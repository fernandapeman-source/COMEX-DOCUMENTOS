...
function applyRules(data) {
  ...
  const map = {
    ...
    CLIENT_ADDRESS_LINE_1:(()=>{ const a=(consigneeAddress||'').trim(); const i=a.indexOf(','); return i>=0?a.slice(0,i).trim():a; })(),
    CLIENT_ADDRESS_LINE_2:(()=>{ const a=(consigneeAddress||'').trim(); const i=a.indexOf(','); return i>=0?a.slice(i+1).trim():''; })(),
